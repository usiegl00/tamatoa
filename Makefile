...
ifeq ($(shell gem info ruby-macho -i), false)
	...
	ruby -- tamatoa.rb macho fflush $(filter-out all,$(MAKECMDGOALS)) | $(CC) -nostartfiles -e _main -O3 -x assembler -o tamatoa.o -
...
nofflush_tamatoa.bin: macho
ifeq ($(shell gem info ruby-macho -i), false)
  @printf "\033[0;31m[-]\033[0m Error: gem not installed: ruby-macho\n"
	@false
else
	ruby -- tamatoa.rb macho macho $(filter-out nofflush,$(MAKECMDGOALS)) | $(CC) -nostartfiles -e _main -O3 -x assembler -o tamatoa.o -
